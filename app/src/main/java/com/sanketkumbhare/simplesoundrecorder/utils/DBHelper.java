package com.sanketkumbhare.simplesoundrecorder.utils;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static OnDatabaseChangeListener mOnDatabaseChangedListener;
    ...
    public static void setOnDatabaseChangedListener(OnDatabaseChangeListener listener) {
